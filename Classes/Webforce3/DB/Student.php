        ...
        if ($stmt->execute() === false) {
            ...
            if (!empty($row)) {
                $currentObject = new Student(
                        $row['stu_id'], new Session($row['session_ses_id']), new City($row['city_cit_id']), $row['stu_lastname'], $row['stu_firstname'], $row['stu_email'], $row['stu_birthdate'], $row['stu_friendliness']
                );
